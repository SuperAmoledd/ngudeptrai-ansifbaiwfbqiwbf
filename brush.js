var Brush = (function () {
    ...
    function Brush (wgl, shaderSources, maxBristleCount) {
        ...
        this.bristleCount = maxBristleCount; 
        ...
        this.randomsTexture = wgl.buildTexture(wgl.RGBA, wgl.FLOAT, maxBristleCount, VERTICES_PER_BRISTLE, new Float32Array(randoms), wgl.CLAMP_TO_EDGE, wgl.CLAMP_TO_EDGE, wgl.LINEAR, wgl.LINEAR); 
